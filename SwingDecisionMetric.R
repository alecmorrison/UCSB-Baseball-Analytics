...
## SHOW BRIAN THIS ONE
PitchRatingDesc("Right", "Right", "Cutter", 83, .3, 2.6)
PitchRating("Right", "Right", "Cutter", 83, .2, 2.6)
...
for(i in 1:nrow(UCSBHitters)){
  UCSBHitters[i,]$`Total/Num` <- (UCSBHitters[i, ]$Total)/(UCSBHitters[i, ]$`# of Pitches Seen`)
}  
